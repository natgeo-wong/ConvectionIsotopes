...
md"
# 01d - Exploring the Precipitation Climatology of Columbia in ERA5
...
begin
	...
	for iax = 1 : 13
		if !isone(iax)
			c = a1[iax].contourf(
				...
				levels=vcat(-5:-1,-0.5,0.5,1:5)/10,extend="both",cmap="RdBu_r"
			)
			if iax == 13
	...
	f1.savefig(plotsdir("01d-era5w500hPa.png"),transparent=false,dpi=300)
	load(plotsdir("01d-era5w500hPa.png"))
end
...
begin
	...
	a2[1].format(xlabel="Month of Year",xlim=(0.5,12.5),ylim=(2,-2)./10,xlocator=1:12)
	...
	f2.savefig(plotsdir("01d-era5w500hPa-ts.png"),transparent=false,dpi=300)
	load(plotsdir("01d-era5w500hPa-ts.png"))
end
...
begin
	...
	a3[1].format(xlabel="Month of Year",xlim=(0.5,12.5),ylim=(5,-5)./10,xlocator=1:12)
	...
	f3.savefig(plotsdir("01d-era5w500hPa-ts-subgeo.png"),transparent=false,dpi=300)
	load(plotsdir("01d-era5w500hPa-ts-subgeo.png"))
end
