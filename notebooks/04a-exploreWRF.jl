...
begin
	...
	tt = 0
		for it = 1 : 10, ihr = 1 : 8
			...
			fol_2D = datadir("wrf","wrfout","AUG","AUGp01")
			fnc_2D = joinpath(fol_2D,"wrfout_d02_$(dt)_00:00:00")
...
begin
	ds  = NCDataset(datadir("wrf","wrfout","AUGp02","wrfout_d02_2019-08-11_00:00:00"))
	tln = ds["XLONG"][:,:,1]
	tlt = ds["XLAT"][:,:,1]
	rn1 = ds["RAINNC"][:]
	d2H1 = ds["HDO_RAINNC"][:]
	close(ds)
	ds  = NCDataset(datadir("wrf","wrfout","AUGp02","wrfout_d02_2019-08-21_00:00:00"))
	rn2 = ds["RAINNC"][:]
	d2H2 = ds["HDO_RAINNC"][:]
	close(ds)
end
...
begin
	...
	c2_2 = a2[2].pcolormesh(
		...
		cmap="Blues",levels=-100:10:0,extend="both"
	)
