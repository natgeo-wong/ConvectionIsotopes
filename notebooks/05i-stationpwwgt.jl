...
begin
	...
	f1.savefig(plotsdir("05i-p_wwgt2vswrfadvec-07dyHDO.png"),transparent=false,dpi=400)
	load(plotsdir("05i-p_wwgt2vswrfadvec-07dyHDO.png"))
end
...
begin
	...
	f2.savefig(plotsdir("05i-p_wwgt2vswrfadvec-07dyO18.png"),transparent=false,dpi=400)
	load(plotsdir("05i-p_wwgt2vswrfadvec-07dyO18.png"))
end
...
begin
	...
	f3.savefig(plotsdir("05i-p_wwgt2vswrfadvec-30dyHDO.png"),transparent=false,dpi=400)
	load(plotsdir("05i-p_wwgt2vswrfadvec-30dyHDO.png"))
end
...
begin
	...
	f4.savefig(plotsdir("05i-p_wwgt2vswrfadvec-30dyO18.png"),transparent=false,dpi=400)
	load(plotsdir("05i-p_wwgt2vswrfadvec-30dyO18.png"))
end
