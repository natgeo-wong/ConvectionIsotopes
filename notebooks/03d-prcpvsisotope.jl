...
begin
	...
	f1.savefig(plotsdir("03d-prcpvO-mo.png"),transparent=false,dpi=150)
	load(plotsdir("03d-prcpvO-mo.png"))
end
...
begin
	...
	f2.savefig(plotsdir("03d-prcpvH-mo.png.png"),transparent=false,dpi=150)
	load(plotsdir("03d-prcpvH-mo.png.png"))
end
...
begin
	...
	f3.savefig(plotsdir("03d-prcpvO-dy.png"),transparent=false,dpi=150)
	load(plotsdir("03d-prcpvO-dy.png"))
end
...
begin
	...
	f4.savefig(plotsdir("03d-prcpvH-dy.png"),transparent=false,dpi=150)
	load(plotsdir("03d-prcpvH-dy.png"))
end
...
begin
	...
	f5.savefig(plotsdir("03d-dy2mo.png"),transparent=false,dpi=400)
	load(plotsdir("03d-dy2mo.png"))
end
...
begin
	...
	f6.savefig(plotsdir("03d-SanAndres.png"),transparent=false,dpi=400)
	load(plotsdir("03d-SanAndres.png"))
end
