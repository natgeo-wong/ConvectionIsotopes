...
function axesformat!(axesnum)
	...
	for ax in axesnum
		ax.format(
			ylim=(1000,0),xlim=(0,120),xlocator=0:100:200,ylocator=0:250:1000,
			xlabel=L"$P - E + u\cdot\nabla q$ / kg m$^{-2}$ day$^{-1}$",
...
begin
	...
	pbin = -1000 : 50 : 1000; ppnt = (pbin[1:(end-1)] .+ pbin[2:end]) / 2
...
begin
	...
	f1.savefig(plotsdir("05f-p_wwgtvswrfadvec-07dyHDO.png"),transparent=false,dpi=400)
	load(plotsdir("05f-p_wwgtvswrfadvec-07dyHDO.png"))
end
...
begin
	...
	f2.savefig(plotsdir("05f-p_wwgtvswrfadvec-07dyO18.png"),transparent=false,dpi=400)
	load(plotsdir("05f-p_wwgtvswrfadvec-07dyO18.png"))
end
...
begin
	...
	f3.savefig(plotsdir("05f-p_wwgtvswrfadvec-30dyHDO.png"),transparent=false,dpi=400)
	load(plotsdir("05f-p_wwgtvswrfadvec-30dyHDO.png"))
end
...
begin
	...
	f4.savefig(plotsdir("05f-p_wwgtvswrfadvec-30dyO18.png"),transparent=false,dpi=400)
	load(plotsdir("05f-p_wwgtvswrfadvec-30dyO18.png"))
end
